...
var menuBtn=eleByClass("app-topbar-menu-btn");var sidebar=eleByClass("app-header");var appContainer=eleByClass("app-container");function toggleSidebar(){hasClass(sidebar,"show")?delClass(sidebar,"show"):addClass(sidebar,"show");};menuBtn.addEventListener("click",function(){hasClass(sidebar,"show")?delClass(sidebar,"show"):addClass(sidebar,"show");});appContainer.addEventListener("click",function(){if(hasClass(sidebar,"show")){delClass(sidebar,"show");}});var isScrolling=false;var isScrollingTimer=null;var lastScroll=0;var animationTick=false;var topbar=eleByClass("app-topbar");function onScrolling(){isScrolling=true;var diff=lastScroll-w.scrollY;if(diff>0&&hasClass(topbar,"hide")){delClass(topbar,"hide");}
