...
const menuBtn=eleByClass("app-topbar-menu-btn");const sidebar=eleByClass("app-header");menuBtn.onclick=function(){hasClass(sidebar,"show")?delClass(sidebar,"show"):addClass(sidebar,"show");};let isScrolling=false;let isScrollingTimer=null;let lastScroll=0;let animationTick=false;const topbar=eleByClass("app-topbar");function onScrolling(){isScrolling=true;const diff=lastScroll-w.scrollY;if(diff>0&&hasClass(topbar,"hide")){delClass(topbar,"hide");}
